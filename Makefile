...
report.docx: report.txt
	pandoc --smart --from markdown+inline_code_attributes -o $@ $<

report.html: report.txt
	pandoc --smart --standalone --from markdown+inline_code_attributes -o $@ $<

report.pdf: report.txt
	pandoc --smart --standalone --variable=geometry:letterpaper,margin=1in --from markdown+inline_code_attributes -o $@ $<
